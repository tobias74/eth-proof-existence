...
export function PrivacyDE() {
    return <>
        ...
        <h4>3. Cookies</h4>
        <p>Die Internetseiten der tobiga UG (haftungsbeschränkt) verwenden Cookies. Cookies sind Textdateien, welche über einen Internetbrowser auf einem Computersystem abgelegt und gespeichert werden.</p>
        ...
        <p>Durch den Einsatz von Cookies kann die tobiga UG (haftungsbeschränkt) den Nutzern dieser Internetseite nutzerfreundlichere Services bereitstellen, die ohne die Cookie-Setzung nicht möglich wären.</p>
        ...
        <h4>10. Datenschutzbestimmungen zu Einsatz und Verwendung von Google Remarketing</h4>
        ...
        <p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für Datenschutz GmbH, die als <a href="https://dg-datenschutz.de/datenschutz-dienstleistungen/externer-datenschutzbeauftragter/" rel="nofollow">Datenschutzbeauftragter</a> tätig ist, in Kooperation mit den <a href="https://www.wbs.legal/it-recht/datenschutzrecht" rel="nofollow">Datenschutz Anwälten der Kanzlei WILDE BEUGER SOLMECKE | Rechtsanwälte</a> erstellt.
        </p>
